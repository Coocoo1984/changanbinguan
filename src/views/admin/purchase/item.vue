<template>
    <div>
        <div class="weui-panel weui-panel_access" style="padding-bottom:10px">
            <div class="weui-panel__bd">
                <div class="weui-media-box weui-media-box_text">
                    ...
                    <p class="weui-media-box__desc">{{purchasing_plan_code}}</p>
                </div>
                <div class="weui-media-box weui-media-box_text">
                    <h4 class="weui-media-box__title" style="font-size:14px">
                        供应商：
                        <span class="count">{{vendor_name}}</span>
                    </h4>
                </div>
            </div>
            <div class="weui-panel__bd">
                    ...
                    <div class="weui-flex__item">
                        <div class="weui-btn-area">
                            <a @click="Aduit"
                               ...
                               href="javascript:">{{status==1?'初审通过': status == 2 ?'复审确认' : '终审确认'}}</a>
                        </div>
                    </div>
                    <div class="weui-flex__item">
                        <div class="weui-btn-area">
        ...
        <preview style="margin-top:10px"
                 static
                 :title="'采购单项目（'+getGoods().length+'）：'"
                 @handler="SelectQuoter()"
                 :btnGray="btnGray"
                 :btnText="btnText"
                 :datas="getGoods()"></preview>
    </div>
</template>
...
<script>
    export default {
        ...
        computed: {
            ...
            //新增 贺彦 20190101
            purchasing_plan_code() {
                return this.$route.query.purchasing_plan_code;
            },
            //新增 贺彦 20190101
            vendor_name() {
                return this.$route.query.vendor_name;
            },
            //新增 贺彦 20190101
            unit_price() {
                return this.$route.query.unit_price;
            },
            //新增 贺彦 20190101
            subtotal() {
                return this.$route.query.subtotal;
            },
            goods_class() {
